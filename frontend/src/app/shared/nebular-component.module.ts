...
import { NbThemeModule, NbLayoutModule, NbIconModule, NbUserModule, NbSidebarModule, NbMenuModule, NbInputModule,
  ...
  NbToastrModule, NbAutocompleteModule, NbButtonGroupModule, NbStepperModule, NbDialogModule, NbCheckboxModule,
  NbActionsModule, NbContextMenuModule, NbBadgeModule } from '@nebular/theme';
